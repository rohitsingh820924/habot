        ...
        <div className="container mx-auto p-4">
            <div className="grid lg:grid-cols-2 items-center gap-10 md:gap-20 lg:gap-40">
                <div>
                    ...
                    <div className='group bg-primary w-full block md:p-5 p-2 text-sm text-white text-center font-semibold md:text-lg rounded-md relative md:max-w-[320px] max-w-[200px]' onClick={() => dispatch(setIsLoginOpen(true))}>Sign up Today !
